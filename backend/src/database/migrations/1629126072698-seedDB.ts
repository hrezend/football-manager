...
export class seedDB1629126072698 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("INSERT INTO team (id, name, headquarters, founded_at, stadium_id) VALUES ('1', 'Paris Saint-Germain Football Club', 'França', '12/08/1970', '1')");
        await queryRunner.query("INSERT INTO team (id, name, headquarters, founded_at) VALUES ('2', 'Chelsea Football Club', 'Reino Unido', '10/03/1905')");
